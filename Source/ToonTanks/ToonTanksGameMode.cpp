...
{
	TargetTowers = GetTragetTowerCount();
	...
	GetWorldTimerManager().SetTimer(PlayerEnableTimerHandle, PlayerEnableTimerDelegate, 3.0f, false);
}

int32 AToonTanksGameMode::GetTragetTowerCount()
{
